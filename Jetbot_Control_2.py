...
# =====================================================================
    # Setup camera
    cap = Jetbot_Setup_2.camera_setup(1280, 720)
    frame_count = 0
    ...
    UDP = Jetbot_Setup_2.UDP(Freq=60)
    '''
    ...
    # Jetbots
    follower1 = Jetbot_Setup_2.Jetbot(26,0,tau=0.2,tau_vel=0.25)   # TagID, 0-follower
    ...
    try:
        while True:
            ...
            if len(tags)==0:
                ...
                for tag in tags:
                    ...
                    if rot_matrix is not None and trans_vector is not None:
                        ...
                        roll, pitch, yaw = Jetbot_Setup_2.rot_to_rpy(rot_workspace)
                        ...
                        if tag_id == follower1.id:
                            ...
                            if collect_data & follower1.visible:
                                ...
                                data_pos_f[count, :] = follower1.pose_f[0]          # Jetbot pose [x,y,z] [mm] (filtered)
                                ...
                                data_lin_vel[count] = follower1.lin_vel
                                data_ang_vel[count] = follower1.ang_vel[0]          # Jetbot ang velocity [rad/s]
            ...
            if follower1.visible:
                ...
                v_cmd , w_cmd = controller.controller_aw([follower1.lin_vel, follower1.ang_vel[0]],[A_GOAL, W_GOAL])
